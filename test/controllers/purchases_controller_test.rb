...
class PurchasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create purchase" do
    assert_difference("Purchase.count") do
      post purchases_url, params: { purchase: { amount: @purchase.amount, author_id: @purchase.author_id, name: @purchase.name } }
    end
  ...
  test "should update purchase" do
    patch purchase_url(@purchase), params: { purchase: { amount: @purchase.amount, author_id: @purchase.author_id, name: @purchase.name } }
